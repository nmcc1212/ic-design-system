...
<DoDontCaution
  ...
  imageAlt="An example page that is scrolled halfway down and zoomed in, with an icon variant back to top button in the bottom right corner."
  state="good"
...
Avoid using the default back to top button when zoomed, as it may obscure important page content. The icon back to top button should be used instead.
