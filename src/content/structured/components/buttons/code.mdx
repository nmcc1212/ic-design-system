...
export const snippetsIcon = [
  {
    language: "Web component",
    snippet: `<ic-button variant="icon-primary" aria-label="refresh">
  <svg
    xmlns="http://www.w3.org/2000/svg"
    height="24px"
    viewBox="0 0 24 24"
...
<ic-button variant="icon-secondary" aria-label="refresh">
  <svg
    xmlns="http://www.w3.org/2000/svg"
    height="24px"
    viewBox="0 0 24 24"
...
<ic-button variant="icon-tertiary" aria-label="refresh">
  <svg
    xmlns="http://www.w3.org/2000/svg"
    height="24px"
    viewBox="0 0 24 24"
...
<ic-button variant="icon-destructive" aria-label="refresh">
  <svg
    xmlns="http://www.w3.org/2000/svg"
    height="24px"
    viewBox="0 0 24 24"
...
`,
  ...
  {
    language: "React",
    snippet: `<IcButton variant="icon-primary" aria-label="refresh">
  <svg
    xmlns="http://www.w3.org/2000/svg"
    height="24px"
    viewBox="0 0 24 24"
